...
- **[HYDRA-UMC-MQTT-BROKER](https://github.com/JuanenRac/HYDRA-UMC-MQTT-BROKER)** — `Vda5050Publisher` de `mqtt_transport.py` envía aquí cada despacho ya validado como un mensaje VDA 5050 `order`/`instantActions` real y conforme al esquema - a diferencia del esquema de topics `hydra/bridges/<nombre>/...` de los 5 puentes estacionarios, este usa directamente el esquema de topics real propio de VDA 5050.
